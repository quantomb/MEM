...
c*******************************************************************************
     ...
     &             nkpoints, info, infot, ickx, icky, i_energy
        ...
        real(kind) :: r1, r2, kx, ky, fill, Epsk, kx1, ky1, kx2, 
     &                ky2, offset, Energy
 ...
 3      format('Enter Energy,nkpoints:  ',$)
     ...
     &'ReSigkw     ImSigkw')")
        ...
        do icky=1,nkpoints
          ...
          c2=blint(kx,ky,i_energy)                      ! Sigma(k,w)
          c1=1.0/(w(i_energy)-ed-Epsk(kx,ky)-c2)        ! G(k,w)
          write(22,"(6(g12.6,1x))") kx,ky,w(i_energy),real(c1),
