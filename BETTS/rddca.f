...
c           first input file.
            ...
            do ick=1,Ncw
              write(6,10) ick,Kc(1,ick),Kc(2,ick)
            end do
            write(6,*) ' icr  Rcx(ick)   Rcy(ick)'
            do icr=1,Nc
              write(6,11) icr,Rc(1,icr),Rc(2,icr)
            end do
...
c           Keep this set of data
 ...
 203    format(2x,f7.3,2x,f7.4,2x,f6.3,2x,f6.3,2x,f7.3,2x,f7.4)
        write(9,*) ' '
        write(9,*) ' '
c        1         2         3         4         5         6         7
c23456789012345678901234567890123456789012345678901234567890123456789012
 ...
 202    format(1x,f7.4,1x,e14.7,1x,e14.7,1x,f5.2,1x,f5.2,1x,f7.4)
